...
def swiglu(
    ...
    normalized = rms_norm(x, norm_weight, epsilon=EPSILON)
    ...
    try:
        ...
        with profile(
            ...
            with record_function("forward/sequence_to_replicate"):
                replicated = normalized.redistribute(mesh, [Replicate()])
            ...
            with record_function("forward/partial_to_sequence"):
                down_sequence = down_partial.redistribute(mesh, [Shard(1)])
