...
class DeepSeekV3ModelArgs:
    ...
    n_heads: int = 16
    norm_eps: float = 1e-5 # eps form RMSNorm
    ...
    def get_nparams_and_flops(self, model: nn.Module, seq_len: int) -> tuple[int, int]:
        ...
        nparams_sparse = nparams_moe_router + nparams_experts + nparams_shared_experts
        ...
        num_flops_per_token = (
            6*(nparams_dense-nparams_embedding+nparams_sparse_active) # MoE Flops
            + 6*(n_layers*n_heads*head_dims*seq_len) # Attention Flops
        )
